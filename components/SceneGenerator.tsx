...
const SceneGeneratorInputs: React.FC<SceneGeneratorProps> = ({ onGenerate, isGenerating, onPromptChange }) => {
  ...
  if (mode === 'element') {
      if (elementSubMode === 'furniture') AVAILABLE_ELEMENTS = FURNITURE_PIECES;
      else if (elementSubMode === 'vehicle') AVAILABLE_ELEMENTS = VEHICLE_TYPES;
  ...
  useEffect(() => {
    ...
    if (mode === 'miniature') {
        ...
        if (elements.length > 0) {
            ...
            if (elementSubMode === 'furniture') elementsString = "Assorted items matching the theme";
            else if (elementSubMode === 'vehicle') elementsString = "A variety of 4 distinct vehicles";
  ...
  }, [mode, elementSubMode, selectedElementThemeId, selectedLocationId, selectedElementIds, customElement, isManuallyEdited, customLocations, landscapeVariant, selectedTimeId, selectedSeasonId, miniatureMode, encyclopediaItems, worldItems, iconItems, selectedIconThemeId]);
      ...
      <div className="space-y-6">
        ...
        {mode === 'element' && (
             <div className="space-y-4 animate-fade-in">
                ...
                {/* Element Picker */}
                <div className="space-y-2">
                      <label className="text-[10px] font-bold text-gray-400 uppercase">2. Select Items to Generate</label>
